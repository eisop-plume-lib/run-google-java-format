...
# For JDK 11, `java -version` has the form: openjdk version "11.0.11" 2021-04-20
# For JDK 17, `java -version` has the form: openjdk version "17" 2021-09-14 LTS
...
java_version = re.search('version \"(\d+(\.\d+)?).*\"', java_version_string).groups()[0]
...
gjf_version_default = "1.7" if (java_version == "1.8") else "1.13.0"
